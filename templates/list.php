		...
		<div data-role="content" data-theme="a">
			<ul data-role="listview" data-filter="true">
				<?php
					...
					$name = $merchant['Name'];
					$id = $merchant['Id'];
					echo  "<li><a href=http://labs.brneese.com/dwolla-here/id/$id>$name</a></li>";
				}
				?>
				</ul>
			</div>
				...
				<center> <a href="./geo" rel="external" data-icon="refresh" data-role="button">Refresh This List</a> </center>
				 </br> </br>
				</div>
		</div>
	</div>
