<?php require 'templates/head.php';?>
    ...
    <a href="./settings" data-rel="dialog" data-transition="slidedown">
      ...
      <div data-role="content" data-theme="a">
          ...
          <a href="#" id="verify"  data-role="button" rel="external"> Deposit Dwolla! </a>
         ...
         <script>                
          $("#verify").click(function() {
            ...
            if (pin == "" || pin.length < '4') {
              ...
              if (cents == "") {
                if (confirm("Despot $" + dollars + "." + cents + " from " + account + "? Note: if this is an ACH transfer, it will take 3-7 business days to process.")) {
                  $('#dwolladwolla').submit();
                }
              } else {
