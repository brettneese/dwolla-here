   ...
   <div data-role="page" data-theme="a">
    ...
    <div data-role="content" data-theme="a">
      <center> <h2> <?php echo $name; ?> </h2> </center>
          <div id="send">
          <form action="withdraw_action" method="post" id="dwolladwolla">
          ...
          <a href="#" id="verify"  data-role="button" rel="external"> Withdraw! </a>
         ...
         <script>                
          ...
          var account = $("#account option:selected").text();
            ...
            if (pin == "" || pin.length < '4') {
              ...
              if (cents == "") {
                if (confirm("Withdraw $" + dollars + "." + cents + " to " + account + "? Note: if this is an ACH transfer, it will take 3-7 business days to process.")) {
                  $('#dwolladwolla').submit();
                }
              } else {
                if (confirm("Withdraw $" + dollars + " to " + account + "? Note: if this is an ACH transfer, it will take 3-7 business days to process.")) {
                  $('#dwolladwolla').submit();
                }
              }
            }
